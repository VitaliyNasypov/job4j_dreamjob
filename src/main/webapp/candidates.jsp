                    ...
                    <tr>
                     ...
                     <thead>
                                            <tr>
                                                    ...
                                                    <tbody>
                                                    <% for (Candidate сandidate : Store.instOf().findAllCandidates()) { %>
                                                        <tr>
                                                            <td><%= сandidate.getId() %></td>
                                                            <td><%= сandidate.getFirstName() %></td>
                                                            <td><%= сandidate.getLastName() %></td>
                                                            <td><%= сandidate.getAge() %></td>
                                                        </tr>
                                            <% } %>
                                            </tbody>
                </table>
